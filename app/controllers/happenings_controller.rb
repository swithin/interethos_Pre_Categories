class HappeningsController < ApplicationController
  ...
  def show
    ...
    # attempts to remove the error that shows on Happening Show/Edit pages for Group
    # @groups_happening = @happening.groups_happening
    # @group = Group.find(@happening.groups_happening)
  ...
  def create
    ...
    respond_to do |format|
      if @happening.save
        ...
        format.html { redirect_to(session[:current_location]) }
